...
/** Represents an entity of a Spriter SCML file. An entity holds {@link Animation}s, an {@link #id}, a {@link #name}.
...
public class Entity {
	...
	/** Represents the object info in a Spriter SCML file. An object info holds a {@link #type} and a {@link #name}. If the type is
	 * a Sprite it holds a list of frames. Otherwise it has a {@link #size} for debug drawing purposes.
	 * 
	 * @author Trixt0r */
	...
	/** Represents a Spriter SCML character map. A character map maps {@link FileReference}s to {@link FileReference}s. It holds an
	 * {@link CharacterMap#id} and a {@link CharacterMap#name}.
	 * 
	 * @author Trixt0r */
