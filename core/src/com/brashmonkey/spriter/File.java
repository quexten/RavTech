...
/** Represents a file in a Spriter SCML file. A file has an {@link #id}, a {@link #name}. A {@link #size} and a {@link #pivot}
 * point, i.e. origin of an image do not have to be set since a file can be a sound file.
 * 
 * @author Trixt0r */
public class File {
	...
	File (int id, String name, Dimension size, Vector2 pivot) {
		this.id = id;
		this.name = name;
		this.size = size;
		this.pivot = pivot;
