 ...
 * 
 * @author Trixt0r */
public class IKObject extends Vector2 {
	...
	/** Sets the chain length of this ik object. The chain length indicates how many parent bones should get affected, when a
	 * {@link IKResolver} resolves the constraints.
	 * 
	...
	/** Sets the number of iterations. The more iterations a {@link IKResolver} is asked to do, the more precise the result will
	 * be.
	 * 
