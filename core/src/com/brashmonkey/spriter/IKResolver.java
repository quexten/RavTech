...
public abstract class IKResolver {
	 ...
	 * {@link #resolve(float, float, int, SpriterAbstractObject, SpriterAbstractPlayer)} .
	 * 
	...
	/** Adds the given object to the internal IKObject - Bone map. This means, the values of the given ik object affect the mapped
	 * bone.
	 * 
	...
	/** Sets the tolerance distance of this resolver. The resolver should stop the algorithm if the distance to the set ik object
