...
public class PlayerTweener extends Player {
	...
	/** Indicates whether to update the {@link Player} instances this instance is holding. If this variable is set to
	 * <code>false</code>, you will have to call {@link Player#update()} on your own. */
	...
	/** Creates a player tweener based on the entity. The players to tween will be created by this instance.
	 * 
	...
	/** Tweens the current set players. This method will update the set players if {@link #updatePlayers} is <code>true</code>.
	 * 
	...
	/** Sets the base animation of this tweener. Has only an effect if {@link #baseBoneName} is not <code>null</code>.
	 * 
	...
	/** Sets the base animation of this tweener by the given animation index. Has only an effect if {@link #baseBoneName} is not
	 * <code>null</code>.
	 * 
	...
	/** Sets the base animation of this tweener by the given name. Has only an effect if {@link #baseBoneName} is not
	 * <code>null</code>.
	 * 
