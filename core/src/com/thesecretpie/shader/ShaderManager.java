...
public class ShaderManager {
    ...
    public ShaderManager(String shaderDir, AssetManager am, boolean addProcessors) {
        ...
        if (addProcessors && (Gdx.app.getType() == ApplicationType.Desktop || Gdx.app.getType() == ApplicationType.Applet
            ...
            /*
             * add("processor", "processor.vert", "processor.frag"); add("processor_blur", "processor.vert",
             * "processor_blur.frag"); add("copy", "processor.vert", "copy.frag"); add("processor_draw", "processor.vert",
             * "processor_draw.frag"); add("processor_fill", "processor.vert", "processor_fill.frag");
             */
        }
    }
    ...
    /*
     * public void setVertexAttribute(java.lang.String name, int size, int type, boolean normalize, int stride, java.nio.Buffer
     * buffer) { if (currentShader != null) { currentShader.setVertexAttribute(name, size, type, normalize, stride, buffer); }
     * else throw new IllegalArgumentException("Can't set uniform before calling begin()!"); }
     */
