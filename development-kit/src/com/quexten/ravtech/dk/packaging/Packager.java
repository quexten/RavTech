...
public class Packager {
	...
	public static void build (BuildReporterDialog dialog,
		...
		if (currentStep == null) {
			...
			currentStep = platforms.get(options.targetPlatform)
				.addBuildEngineStep(dialog, currentStep, options);
		}
	...
	private static PackageStep addRunStep (BuildReporterDialog dialog,
		...
		return currentStep.setNextStep(new RunPlatformStep(dialog,
			platforms.get(options.targetPlatform), options));
	}
