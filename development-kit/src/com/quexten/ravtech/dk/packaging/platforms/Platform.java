...
public abstract class Platform<V extends BuildOptions, K extends VisTable> {
	...
	public abstract void build (BuildReporterDialog buildReporterDialog, V options);

	/** Runs the latest build of the project
	 * @param buildReporterDialog - the BuildDialog to log the progress in
	 * @param deviceIdentifier - the Device the Build should be run on */
	public abstract void run (BuildReporterDialog buildReporterDialog, V option);
	...
	public abstract PackageStep addBuildEngineStep (BuildReporterDialog dialog, PackageStep currentStep, V options);
