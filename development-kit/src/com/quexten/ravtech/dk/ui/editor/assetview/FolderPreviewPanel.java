...
import com.quexten.ravtech.dk.ui.editor.assetview.AssetViewer.AssetView;

public class FolderPreviewPanel extends AssetPreviewPanel {

	final static String folderIconPath = "ui/icons/folder.png";

	public FolderPreviewPanel (AssetViewer viewer, String folderName) {
		super(viewer, folderName);
