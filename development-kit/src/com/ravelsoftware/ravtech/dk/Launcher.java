...
public class Launcher {
    ...
    static void configureUILook () {
        ...
        while (keys.hasMoreElements()) {
            ...
            if (String.valueOf(key).endsWith(".selectionBackground")) UIManager.put(key, RavTechDKUtil.getAccentColor());
        }
        ...
        RavTech.settings.addValueListener("RavTechDK.android.sdk.dir", new SettingsValueListener() {
            ...
            public void settingChanged (Object oldValue, Object newValue) {
                ...
                AdbManager.adbLocation = new File(
                    String.valueOf(newValue) + System.getProperty("file.separator") + "platform-tools");
