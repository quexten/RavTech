	...
	public static void initialize () {
		UpdateManager.addUpdater("ZeroBraneStudio", new GitHubUpdater("pkulchenko", "ZeroBraneStudio")
			...
			.addPostUpdateHook(new Runnable() {
				@Override
				public void run () {
					RavTechDK.getLocalFile("resources/zerobrane/ravtech-api.lua").copyTo(RavTechDK.getLocalFile("ZeroBraneStudio/api/lua/ravtech.lua"));
					RavTechDK.getLocalFile("resources/zerobrane/ravtech-interpreter.lua").copyTo(RavTechDK.getLocalFile("ZeroBraneStudio/api/lua/ravtech.lua"));
				}				
			}));
	}
